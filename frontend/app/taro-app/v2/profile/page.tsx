...
import { listV2Invoices, type InvoiceV2 } from "@/lib/v2/invoices";
...
export default function TaroV2ProfilePage() {
      ...
      <div className="phone-shell flex flex-col min-h-screen pb-[96px]">
        ...
        <div className="px-4 pt-4">
          <div className="bg-white border border-taco-border rounded-2xl overflow-hidden">
            ...
            />
            <Divider />
            <SettingsRow label="Bahasa" hint="Indonesia" chevron={false} disabled />
            <Divider />
            <SettingsRow
              label="Bantuan / FAQ"
...
function StatTile({ label, value }: { label: string; value: string }) {
  return (
    <div className="bg-white border border-taco-border rounded-xl p-3 min-h-[88px] flex flex-col items-center justify-center text-center">
      ...
      <div className="text-[12px] text-taco-sub mt-1.5 leading-tight">{label}</div>
    </div>
  );
}
